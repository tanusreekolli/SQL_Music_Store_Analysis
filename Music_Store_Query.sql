...
/* Invoice total price = unit price * quantity */
...
CTEs are temporary named result sets created from a simple SELECT statement that can be used in a subsequent SELECT statement */
